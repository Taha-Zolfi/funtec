...
const mockDb = {
  getNews: () => [
    {
      id: 1,
      title: 'راه‌اندازی جدیدترین پارک تفریحی در تهران',
      excerpt: 'پارک تفریحی جدید با تجهیزات مدرن و ایمن برای کودکان و بزرگسالان افتتاح شد.',
    ...
    {
      id: 2,
      title: 'نکات ایمنی مهم در استفاده از تجهیزات شهربازی',
      excerpt: 'راهنمای کاملی برای والدین جهت اطمینان از ایمنی کودکان در شهربازی‌ها.',
      content: 'محتوای کامل خبر...',
      category: 'ایمنی',
      author: 'مریم کریمی',
    ...
    {
      id: 3,
      title: 'معرفی محصولات جدید فان تک',
      excerpt: 'آشنایی با جدیدترین تجهیزات شهربازی تولید شده توسط فان تک.',
      content: 'محتوای کامل خبر...',
      category: 'محصولات',
      author: 'حسن رضایی',
    ...
    {
      id: 4,
      title: 'بازسازی پارک آبی کیش با تجهیزات جدید',
      excerpt: 'پارک آبی کیش با نصب تجهیزات جدید و مدرن بازسازی شد.',
      content: 'محتوای کامل خبر...',
      category: 'پروژه‌ها',
      author: 'سارا محمدی',
    ...
    {
      id: 5,
      title: 'استانداردهای جدید ایمنی در تجهیزات شهربازی',
      excerpt: 'معرفی استانداردهای جدید بین‌المللی برای ایمنی تجهیزات شهربازی.',
      content: 'محتوای کامل خبر...',
      category: 'ایمنی',
      author: 'احمد رضایی',
    ...
    {
      id: 6,
      title: 'افتتاح بزرگترین شهربازی خاورمیانه',
      excerpt: 'بزرگترین شهربازی منطقه خاورمیانه با حضور مقامات رسمی افتتاح شد.',
      content: 'محتوای کامل خبر...',
      category: 'رویدادها',
      author: 'فاطمه احمدی',
  ...
  updateNews: (id, updates) => {
    console.log(`Updating news ${id} with:`, updates);
  }
};

// Optimized NewsItem component with memo
      ...
      <div className="news-thumbnail">
        ...
        <div className="thumbnail-overlay">
          <div className="article-actions">
            <button 
              className={`action-btn bookmark ${bookmarkedArticles.has(article.id) ? 'active' : ''}`}
            ...
            <button 
              className={`action-btn like ${likedArticles.has(article.id) ? 'active' : ''}`}
...
const News = () => {
  ...
  useEffect(() => {
    const loadArticles = () => {
      try {
        const allArticles = mockDb.getNews();
        ...
        const suggestions = [...new Set(allArticles.flatMap(article => 
          article.title.split(' ').concat(article.excerpt.split(' '))
  ...
  const handleReadArticle = useCallback((article) => {
    try {
      mockDb.updateNews(article.id, { views: (article.views || 0) + 1 });
    ...
    <div className={`news-page ${isLoaded ? 'loaded' : ''} ${darkMode ? 'dark-mode' : ''} font-${fontSize} ${!animationsEnabled ? 'no-animations' : ''}`}>
      ...
      {breakingNews && (
        <div className="breaking-news-ticker">
          <div className="breaking-news-content">
            <span className="breaking-news-label">خبر فوری</span>
      ...
      <div className="news-container">
        ...
        <section className="news-stats">
          ...
          <div className="stat-item">
            <div className="stat-number">{stats.featuredCount || 0}</div>
            <div className="stat-label">اخبار ویژه</div>
          </div>
          <div className="stat-item">
          ...
          <div className="stat-item">
            <div className="stat-number">{bookmarkedArticles.size}</div>
            <div className="stat-label">نشان‌شده‌ها</div>
          </div>
          <div className="stat-item">
        ...
        <section className="news-archive">
          ...
          <div className="archive-months">
            <Link to="/news?date=2024-01" className="archive-month">دی ۱۴۰۲</Link>
            <Link to="/news?date=2024-02" className="archive-month">بهمن ۱۴۰۲</Link>
            <Link to="/news?date=2024-03" className="archive-month">اسفند ۱۴۰۲</Link>
            <Link to="/news?date=2024-04" className="archive-month">فروردین ۱۴۰۳</Link>
            {!isMobile && (
              <>
                <Link to="/news?date=2024-05" className="archive-month">اردیبهشت ۱۴۰۳</Link>
                <Link to="/news?date=2024-06" className="archive-month">خرداد ۱۴۰۳</Link>
              </>
            )}
          </div>
        </section>
